...
device_map = {
    ...
    # === connector部分 ===
    'connector.dynamic_pooling': 'cuda:0',
    ...
    'language_model.model.layers.1': 'cuda:1',
    'language_model.model.layers.2': 'cuda:1',
    'language_model.model.layers.3': 'cuda:1',
    'language_model.model.layers.4': 'cuda:1',
    ...
    'language_model.model.layers.18': 'cuda:1',
    'language_model.model.layers.19': 'cuda:1',
    'language_model.model.layers.20': 'cuda:1',
    'language_model.model.layers.21': 'cuda:1',
    'language_model.model.layers.22': 'cuda:1',
    'language_model.model.layers.23': 'cuda:1',
    'language_model.model.layers.24': 'cuda:1',
    'language_model.model.layers.25': 'cuda:1',
    'language_model.model.layers.26': 'cuda:1',
    'language_model.model.layers.27': 'cuda:1',
    'language_model.model.layers.28': 'cuda:1',
    'language_model.model.layers.29': 'cuda:1',
    'language_model.model.layers.30': 'cuda:1',
    'language_model.model.layers.31': 'cuda:1',
    'language_model.model.norm': 'cuda:1',
    'language_model.lm_head': 'cuda:1',
}
